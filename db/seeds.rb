...
questions = Question.create([{body: 'When was Ruby created?', test_id: tests[0].id},
                             ...
                             {body: 'What is the main idea of Ruby?', test_id: tests[0].id},
                             {body: 'What websites are built on Ruby on Rails?', test_id: tests[1].id}])

answers = Answer.create([{body: '1995',correct: true, question_id: questions[0].id},
                         {body: '2000',correct: false, question_id: questions[0].id},
                         {body: '2002',correct: false, question_id: questions[0].id},
                         {body: '2005',correct: false, question_id: questions[0].id},
                         {body: '1995',correct: false, question_id: questions[1].id},
                         {body: '2000',correct: false, question_id: questions[1].id},
                         ...
                         {body: 'It is the standard markup language for documents designed to be displayed in a web browser',correct: false, question_id: questions[2].id},
                         {body: 'It is a versatile programming language used for creating interactive web applications',correct: false, question_id: questions[2].id},
                         ...
                         {body: 'Mail.ru, Wikipedia, Microsoft Bing, Yandex',correct: false, question_id: questions[3].id},
                         {body: 'Rambler, Habr, 4PDA, Facebook',correct: false, question_id: questions[3].id}])
